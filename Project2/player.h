...
//#ifndef CS2170_PLAYER_H
//#define CS2170_PLAYER_H
#include "mytype.h"
#ifndef PlayerClass_H
#define PlayerClass_H

const int MAX_PLAYERS = 4;			//Maximum players
const int MAX_PLAYER_CARDS = 13;			//Maximum cards held by the player
